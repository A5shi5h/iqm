      ...
      <div>
        ...
        <div className="z-10 max-w-xl space-y-2">
          <h1 className="text-[80px] font-bold leading-[80px]">
            ...
            <span
              className={`${coolvetica.className} text-[#11796B] font-normal tracking-[1.25px]`}
            >
              Inquisitive
            </span>
          ...
          <p className="italic text-gray-600 text-[16px] font-normal pt-2">
          ...
          <button
            ...
            className="mt-6 bg-[#11796B] text-white text-lg font-semibold px-8 py-3 rounded-full hover:bg-black transition-all cursor-pointer"
          >
            Get Started
          </button>
        </div>
