  ...
  return (
    ...
    >
      ...
      <div className="z-10 space-y-4">
        <h1
          className={`${coolvetica.className} text-[48px] sm:text-[64px] font-normal leading-tight text-center pb-4 mb-10 border-b`}
        >
          About Us
        </h1>
        <p
          className={`${sansation.className} font-normal text-2xl text-center px-14`}
        >
          IQM began in Sikkim to meet the rising demand for competitive exam and
          board exam coaching. Starting with offline classes, it has grown into
          one of the top education institutes in the region.
        </p>
      </div>
    </section>
  );
