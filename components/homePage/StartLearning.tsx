    ...
    <section className="relative bg-white py-20 px-6 md:px-12 mt-20">
      ...
      <Image
        ...
        <div className="md:w-1/2">
          <h2 className={`${coolvetica.className} text-4xl md:text-6xl font-normal leading-tight mb-4`}>
            It's Easy to <br />
            start{" "}
          ...
          <p className={`${sansation.className} text-gray-700 text-[20px] mt-4 w-[30rem]`}>
            A few clicks, a few details, and you're already one step closer to
            success in your next exam. Just tell us your name, class, board,
            and the exam you're preparing for!
          </p>
        </div>
